...
function CustomCaption({ displayMonth }: CaptionProps) {
  ...
  return (
    <div className="flex items-center justify-between gap-1 px-1">
      ...
      >
        <SelectTrigger className="h-7 w-[100px] text-xs font-medium border-0 bg-transparent focus:ring-0 focus:ring-offset-0 px-2">
          <SelectValue />
        </SelectTrigger>
      ...
      >
        <SelectTrigger className="h-7 w-[70px] text-xs font-medium border-0 bg-transparent focus:ring-0 focus:ring-offset-0 px-2">
          <SelectValue />
        </SelectTrigger>
        <SelectContent className="max-h-[200px]">
          {years.map((year) => (
